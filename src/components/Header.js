            ...
            <div className='flex items-center justify-between'>
                ...
                <div className="flex gap-2">
                    ...
                    {user && <div className="flex gap-2">
                        <select className="bg-red-500 text-black font-semibold rounded-md p-2 cursor-pointer outline-none">
                            {SUPOORTED_LANGUAGE.map(lang => <option className="cursor-pointer" value="en">English</option>)}
                        </select>
                        <button onClick={handleGptSearchClick} className="bg-purple-500 rounded-md px-4 py-2 mx-4">AI Search</button>
